  ...
  return (
    <nav className="px-24 py-12 flex justify-between items-center">
      <div className="flex gap-16 items-center">
        <Image src="/img/logo.svg" alt="home" width="286" height="80" />
        <div className="flex gap-8 text-[24px] font-semibold">
      ...
      <Link href="/contact" className="border border-[#EF7206] text-[#EF7206] hover:bg-[#EF7206] hover:text-white rounded-full px-12 py-3 text-[20px] font-semibold">Book a consultation</Link>
    </nav>
  )
}
...
function Footer() {
  ...
  return (
    <footer className="bg-[#4E565F] text-white grid justify-center pt-9 pb-[72px] gap-16">
      ...
      <p>©{now.getFullYear()} VBNC Physical Therapy, LLC || Created by <Link href="https://www.varial.dev" className="text-[#7EB9EE]">Varial Web Development</Link></p>
    </footer>
  )
}
